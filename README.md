...
The School Library project allow you to add books, search for books, authors and students.
...
```sh
  cd my-folder
  git  https://github.com/saluumaa/School-Library.git
```
...
To add an [issue](https://github.com/MosDevx/School-Library/issues)
